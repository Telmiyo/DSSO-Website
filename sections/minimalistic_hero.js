  ...
  return (
    <div className="flex flex-col justify-center items-center h-screen w-full ">
      <div className="p-5 backdrop-blur-md mt-12 bg-white/30 w-fit rounded-xl text-center">
        <h1 className="font-fonseca text-6xl text-center text-white">DUNE:</h1>
        ...
        <a
          ...
          href={
            "https://github.com/Chamfer-Studios/Dune-Special-Spice-Ops/releases/download/v1.0-Gold/Dune_SSO.zip"
          }
