...
export default function Team({ teammembers }) {
  ...
  return (
    <PageLayout className="items-center space-y-4">
      <div>
        <Image
      ...
      <div className="flex flex-row-reverse ">
        <div className="flex flex-col w-1/2 space-y-4 pl-16 pt-16">
          ...
          <h3 className="text-7xl font-semibold">DIRECTION TEAM</h3>
          <p className="text-lg">
            We present you our direction team, led by Paula Hitz as the
            Producer, and with María Calle as Lead Designer, Álex Ávila as Lead
            Programmer, and Guillem Álava as Lead Artist.
          </p>
      ...
      <div className="flex ">
        <div className="flex flex-col w-1/2 space-y-4 pl-16 pt-16">
          ...
          <h3 className="text-7xl font-semibold">PROGRAMMING TEAM</h3>
          <p className="text-lg">
      ...
      <div className="flex flex-row-reverse ">
        <div className="flex flex-col w-1/2 space-y-4 pl-16 pt-16">
          ...
          <h3 className="text-7xl font-semibold">DESIGN TEAM</h3>
          <p className="text-lg">
      ...
      <div className="flex ">
        <div className="flex flex-col w-1/2 space-y-4 pl-16 pt-16">
          ...
          <h3 className="text-7xl font-semibold">ART TEAM</h3>
          <p className="text-lg">
          And last but not least, we have our art team, Martí Davicino, Víctor
          Jara, Carles López, Martí Buxeda, and Guillem Álava as their lead.
          </p>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 justify-items-center my-16" id="member-grid">
        {teammembers
