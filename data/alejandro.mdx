...
<Tabs.Group aria-label="Default tabs" style="default">
  ...
  <Tabs.Item title="Projects">
    ...
    <Image src="/contents/screenshots/alejandro_influence.png" width={4} height={3} layout="responsive"/>
          ## JR Supermercats
    ...
    <Image src="/contents/screenshots/alejandro_jr.png" width={4} height={3} layout="responsive"/>
