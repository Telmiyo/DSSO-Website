  ...
  <Tabs.Item title="Background">
    # Background
      ## About Me
        ...
        I have always loved video games ever since I got introduced to them. As I grew, my likes changed and shifted but there was always a constant: Video games.
        When I was in High School I leaned towards a more techological background. My favourite subjects always were maths, physics and techology. When the time to choose a degree came I felt very lost since I didn't know exactly where to go forward. I spent many days asking my friends, teachers, family and most of all myself for guidance, some sort of sign.
  ...
  <Tabs.Item title="Projects">
     # Projects
        Here you have some of my projects I have been in from university that I am most proud of.
          ...
          ## Shattered Dreams
            Shattered Dreams was created with the help of [Guillem Àlava](/guillem), [Abraham Díaz](/abraham), [Aram Galarza](/aram), [David Montufo](/montu) and [Arnau Lucena](/arnau) and myself and it's a turn-based RPG game created for the Project II subject.
