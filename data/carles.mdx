  ...
  <Tabs.Item title="Background">
    # Background
      ## About Me
        ...
        one day I discovered the concept of a video game. Since that day, I have been playing a wide variety
        ...
        2018, where I could get my first PC only for me. I still used Blender to help me study technical
        ...
        a golden opportunity. When I started this degree I was very lost in which path I would choose, since 
        it was a bigger world than I thought, but somehow the subjects related with art and design called my 
        atention, so I was doubting about that many times. Some subjects that awoke my creativity were
        ...
        me the will to learn more. My focus on this project has been the environments, due to neither animations nor
      ...
      ## Experience
        ...
        <JobCard link="https://werfen.com/es/es" img="/contents/screenshots/carles_werfen.jpg" title="Auditory Department" subtitle="Werfen" desc="Managing information in the base data."/>
  </Tabs.Item>
    ...
    # Contribution
      ...
      ## Main Tasks
        ### <u>Props Creation</u>
          ...
          attractive in a visual way and that correlates with the history and lore. Here there are some examples and
          the results:
          ...
          <Image src="/contents/screenshots/carles_environments_1.jpg" width={800} height={400}/>
