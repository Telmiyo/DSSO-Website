  ...
  <Tabs.Item title="Background">
    # Background
      ## About Me
        ...
        great ambitions and a clear idea of what they wanted to do, but I still couldn't decide, because I learned that I liked both paths.<br/>
        ...
        discover what I liked the most; visual programming and design.<br/>
    ...
    # Contribution
      ...
      ## Main Tasks
        ### <u>Menu Implementation</u>
          ...
          work hand-in-hand with the design team.<br/>

          I started with the most simple ones; the main menu, game over menu and winning menu, and then I worked my way up to those 
          which required a more complex implementation, such as the transition menu or the settings. Finally, I created the pause menu that can
          be found inside the levels.<br/>
        ...
        ### <u>Cutscenes Implementation</u>
          ...
          task of creating all the scripts related the cutscenes. Also for this task I had to work hand-in-hand with the designers.<br/>
          ...
          Even thought this task didn't require a higher knowledge in programming, it was slow to do and, therefore it took me a long time 
          to complete.
      ...
      ## Secondary Tasks
        ...
        ### <u>Scripting Module</u>
          At the first stages of the project, I worked hand-in-hand with Tomás Carreras in order to create the scripting module. This 
