...
So in our small group of 5 artists we distributed the modeling tasks between [Carles Lopez](/carles) and I, he would make all the 
assets related to the stage and I would do the characters. Although later we were exchanging tasks to help each other and not get 
...
for not being interested enough. I have come to the decision that I want to be a 3D modeler.
...
others who have only been in charge of the production of 3D assets.

We have only been two, the people who have had modeling as their main task throughout the process. [Carles Lopez](/carles) and I have 
...
project it wasn't clear if we could have different channels for the texture maps (albedo, metallic, roughness, etc...).
...
Mainly, [Carles Lopez](/carles) was in charge of the stage assets, and I of the characters.
...
on possible corrections. That has allowed us to have a consistent style.
...
years. But I think that the final result is not as important as the way in which we have contributed our part to these projects.
...
time does not allow us, because we are busy with the university, we are always thinking about something.
