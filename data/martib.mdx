...
description: "Hello, my name is Martí Buxeda, and I'm on a quest to find absolute silence!
...
I think it's a fantastic opportunity to learn about how the real industry operates, and everyone should 
...
<Tabs.Group aria-label="Default tabs" style="default">
  <Tabs.Item title="Background">
    # Background
      ## About Me
        I've always imagined life as a hardmode video game in which your first chance is your last.
        ...
        **Marti Buxeda** is a programmer who enjoys innovating and creating strange mechanics that transport people 
        ...
        > Abilities have a limitation, they only occur when you're interested on what youre doing!
    ...
    # Contribution
      ...
      ## Main Tasks
        ...
        ### <u>Music Related</u>
          ...
          - Creation of the sound effects of the videogame.
              ...
              <Youtube videoId="zlYuogglQZo" opts={{height: "390", width: "640"}} className="mt-5" />
      ...
      ## Secondary Tasks
        ### <u>Audio System Coding</u>
          ...
          **Track-Specific Feature**: Offset, Mute, Bypass FX, Loop, Custom Loop (choose where the loop starts), Play On Awake and 
