...
artstation: "https://www.artstation.com/kiwitrek"
description: "What's up, I'm Guillem; but most people know me by 'Kiwi' — the bird, not the fruit. I may not be able to fly but I aspire to reach great heights.
As my first major artistic and leading role, it has been an honor and a pleasure to represent each of us 5 members of the team, and I believe this experience 
has been incredibly revealing to what life has to give to me."
---
  ...
  <Tabs.Item title="Background">
    # Background
      ## About Me
        ...
        - Miquel Ángel Garcías, Technical Manager at Omnidrone
    ...
    # Contribution
      ...
      ## Main Tasks
        ### <u>Team Management & Logistical Support</u>
          ...
          <Image src="/contents/screenshots/guillem_logistic_support.png" width={600} height={320}/>
        ...
        ### <u>2D & 3D Generalist Work</u>
          ...
          #### Sardaukar
          <SketchfabCard sketchfabId="15a688f475e94d44a15abc4be0451658"/>
          
          #### Rabban Animation Reel
          ![Rabban Reel](/contents/screenshots/guillem_rabban_reel.gif)

          #### Environmental Props
          <SketchfabCard sketchfabId="b4b1cf52015d4ba7ae217e2cebc2132c"/>

          #### Concept Art
          <Image src="/contents/screenshots/guillem_concept_art.png" width={600} height={454}/>

          #### Particle Alphas
          <Image src="/contents/screenshots/guillem_particle_alphas.png" width={600} height={400}/>
      ...
      ## Secondary Tasks
        ### <u>Level 3 Layout & Decoration</u>
          Using the designers' blockout as reference, I replaced the assets with the ones created by the art department.
          <Image src="/contents/screenshots/guillem_level_2.png" width={600} height={346}/>
     ...
     # Projects
        Finally, here are some of the artistic projects I have partaken related with art throughout the degree, both inside and outside.
          ...
          ## 3D Scenario: Dojo Raid
            ...
            If you want to check our development document, click [here](https://drive.google.com/file/d/1YnSZEVhZGuxuMh2ILvzKX4tSfSJjSMhu/view?usp=sharing) to see it.
          ...
          ## Shujan
            ...
            It's one of the best 2D projects I have created, so that's why it's included here.<br/><br/>
