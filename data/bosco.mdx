...
description: "Hi! My name is Bosco and I am very happy to have contributed my grain of sand as a programmer to the development of Dune: Special Spice Ops at Chamfer Studios.
  ...
  <Tabs.Item title="Background">
    # Background
      ## About Me
        ...
        and that will make it even better in the future.
        ...
        Now that I have a global vision about different fields and how it all works in the industry, I know that I want to be a programmer.
        ...
        and I think this is beautiful, since there's always something left to learn.
      ...
      ## Hard Skills
        - Programming Languages: C/C++, C#, Dart, etc.
        - Frameworks: Flutter
        - Tools: Git, GitHub, Unity, Unreal Engine, Photoshop, Illustrator, Figma, 3Ds Max, Maya, etc.
        - Backends: Firebase
      ...
      ## Experience
        ...
        img="/contents/screenshots/bosco_logo_mueblesboscobarber.png"
        title="Web Development and Marketing Assistance"
        subtitle="Muebles Bosco Barber"
        desc="I worked on the company webpage, developing and maintaining it. I also helped on keeping a proper brand image, clean and up to date."/>
  </Tabs.Item>
  ...
  <Tabs.Item title="Contribution">
    # Contribution
      ## Project Overview
        ...
        together with bug fixing and helping other teammates when needed.

      ## Main Tasks
        ### <u>Base Engine</u>
          We started the project with Ko-Fi Engine as the base which was developed by [Álex Ávila](/alex) and I.
          The base provided the essential features plus the shader module.
        ...
        ### <u>Animation Module</u>
          ...
          Finally, we managed to reach a solid animation module, completely integrated with the rest of the code, specially with the components system and the resource manager.
          
          <Image src="/contents/screenshots/bosco_module_animation.gif" width={600} height={600}/>
          ...
          and other properties can such as the animation loop can be modified.

          <Image src="/contents/screenshots/bosco_component_animator.png" width={300} height={400}/>

        ### <u>Runtime</u>
          I managed to have a proper time management when playing, pausing or stopping the game both in the engine or in the game itself.

          This is important since most of the game elements depend on game time, and it needs function properly before, during and after the game is played.
      ...
      ## Secondary Tasks
        ### <u>Engine Improvements & Help</u>
          ...
          or errors with the animations themselves. I also helped developing some characters, enemies or fixing bugs on them.

        ### <u>Custom File Formats</u>
        I managed to have and keep up to date the mesh and the animation custom file format (.sugar and .cake respectively).
  </Tabs.Item>

  <Tabs.Item title="Projects">
     # Projects
        These are some of the projects I developed together with other classmates. You can check more out on my GitHub!
          ## Wasabi Warriors
            ...
            <Image src="/contents/screenshots/bosco_project1_wasabiwarriors.png" width={600} height={300}/>
          ...
          ## U.N. Squadron
            ...
            It has a sequel game named Carrier Air Wing (U.S. Navy in Japan) which was released in 1990 for the CP system arcade.
            
            <Image src="/contents/screenshots/bosco_project2_unsquadron.png" width={600} height={300}/>

          ## Apollo Mission
            it's a spaceship video game developed using our own physics engine.
            
            The game is about launching our spaceship from Earth, landing safely on the Moon and returning safely to Earth;
            dodging the different asteroids and achieving the landing conditions.
            
            <Image src="/contents/screenshots/bosco_project3_apollomission.png" width={600} height={300}/>
  </Tabs.Item>
</Tabs.Group>
